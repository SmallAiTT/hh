...
module hh{
    export class UIImg extends Node{
        ...
        //+++++++++++++++++纹理缩放参数 开始++++++++++++++++++++++++++++++++++++++
        set textureSx(textureSx:number){
            this._imgOpt.textureSx = textureSx;
        }
        get textureSx():number{
            return this._imgOpt.textureSx;
        }
        set textureSy(textureSy:number){
            this._imgOpt.textureSy = textureSy;
        }
        get textureSy():number{
            return this._imgOpt.textureSy;
        }
        setTextureScale(textureSx:number, textureSy?:number){
            textureSx = textureSx == null ? textureSy : textureSx;
        ...
        _loadTexture(texture:Texture):boolean{
            if(texture){
